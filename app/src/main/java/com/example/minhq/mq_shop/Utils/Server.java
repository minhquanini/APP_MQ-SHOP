package com.example.minhq.mq_shop.Utils;
...
public class Server {
    ...
    public static String pathpostidcat="http://" + localhost + ":8080/MQ-SHOP/ws/webservice/productcategory";
    public static String pathpostidbrd="http://" + localhost + ":8080/MQ-SHOP/ws/webservice/productbrand";
    public static String pathpostattribute="http://" + localhost + ":8080/MQ-SHOP/ws/webservice/attribute";
